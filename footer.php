<?php $logo =  get_field('footer_logo_img', 'option'); ?>
<footer class="container">
	<div class="flex-between-center gap-8 -lg:flex-col -lg:items-start">
		<div class="box-title">
			...
			<!-- </h2> -->
			<p class="sub-title body-2 text-utility-gray-950">
		...
		<div class="form-email -md:w-full">
			...
			<form action="">
				<div class="flex-between text-utility-gray-500 bg-utility-gray-100 py-1 pr-1 rounded-1">
					<input class="pl-2.5 bg-utility-gray-100 flex-1 focus:outline-none" type="email" name="email"
						placeholder="<?php _e('Email', 'canhcam'); ?>">
	...
	<div class="link-footer">
		<div class='location-info'>
			...
			if ($footer_info):
			?>
			<ul class="body-2 flex flex-col gap-4">
			...
			<?php endif; ?>
			<?php
			$gallery_certificates = get_field('footer_certificates_gallery', 'option');
			if ($gallery_certificates):
			?>
			<div class="certificates-gallery mt-6">
				<div class="swiper swiper-footer-logo">

					<div class="swiper-wrapper">

						<?php foreach ($gallery_certificates as $image): ?>
		...
		<div class="our-products-footer flex flex-col gap-6">
